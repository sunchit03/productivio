    ...
    <form onSubmit={handleSubmit} className="mb-4 w-full" >
      <div className="relative">
        <input
          ...
          className={`py-2 px-3 pr-25 w-full text-base rounded font-weight:bold text-black ${window.innerWidth < 639 && !taskBarCollapse ? "bg-gray-300/90" : "bg-gray-50"} placeholder-gray-300 focus:outline-none focus:bg-white focus:ring-1 focus:ring-violet-500`}
        />
        <span 
