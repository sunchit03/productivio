...
const handleDueDateUpdate = async(taskId, date) => {
  ...
  return (
    <div className="p-4 sm:p-6 bg-white shadow-md rounded-lg max-w-full overflow-x-auto h-screen">
      ...
      <div className="relative p-2 shadow-xl rounded-md bg-gray-50 min-w-[35%] max-w-[50%] min-h-[60%] lg:min-w-[50%] md:min-w-[50%] md:min-h-[50%] sm:min-h-[50%] sm:min-w-[75%] flex flex-col justify-between z-50" onClick={(e) => {e.stopPropagation(); setCVDatePicker(false); setDeleteModal(false)}}>
      <DetailTaskView
